                    ...
                    <td>
                        <div class="d-row">
                            <form action="{{ route('caissierTransaction.cancel', $transaction->id) }}" method="post" style="display: inline;" id="cancelForm-{{ $transaction->id }}">
                                @csrf
                                @method('PUT')
                                <button type="button" class="btn btn-sm btn-secondary" onclick="confirmCancel(event, {{ $transaction->id }})" style="background-color: #5CE1E6; border-color: #5CE1E6;">Cancel Transaction</button>
                            </form>
                        </div>
                    </td>
                </tr>
