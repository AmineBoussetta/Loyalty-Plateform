...
@section('main-content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('gerantCaissiers.store',['gerant' => $gerant]) }}" method="post">
                @csrf
                <div class="form-group">
                    <label for="Caissier_ID">ID</label>
                    <input type="text" class="form-control @error('Caissier_ID') is-invalid @enderror" name="Caissier_ID" id="Caissier_ID" placeholder="{{ $Caissier_ID }}" autocomplete="off" value="{{ old('Caissier_ID',$Caissier_ID) }}" readonly>
                    @error('Caissier_ID')
