        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="number" step="0.01" class="form-control" id="amount" name="amount" placeholder="Enter amount" autocomplete="off" value="{{ old('amount') }}">
                        ...
                        <div class="col-sm-4">
                            <input type="number" step="0.01"  class="form-control" id="points" name="points" placeholder="Enter number of converted points" autocomplete="off" value="{{ old('points') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="number" step="0.01" class="form-control" id="minimum_amount" name="minimum_amount" placeholder="Enter minimum amount" autocomplete="off" value="{{ old('minimum_amount') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="number" step="0.01" class="form-control" id="amount_premium" name="amount_premium" placeholder="Enter amount" autocomplete="off" value="{{ old('amount_premium') }}">
                            <small class="form-text text-muted">Enter the amount of money that will be converted to points .</small>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <input type="number" step="0.01" class="form-control" id="points_premium" name="points_premium" placeholder="Enter number of converted points" autocomplete="off" value="{{ old('points_premium') }}">
                            <small class="form-text text-muted">Enter the number of F.Points that will be converted from the amount of money inserted .</small>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="number" step="0.01" class="form-control" id="minimum_amount_premium" name="minimum_amount_premium" placeholder="Enter minimum amount" autocomplete="off" value="{{ old('minimum_amount_premium') }}">
                            <small class="form-text text-muted">Enter the minimum amount of money spent to start converting money to F.Points .</small>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-control" id="conversion_factor" name="conversion_factor" placeholder="Enter conversion factor" autocomplete="off" value="{{ old('conversion_factor') }}">
